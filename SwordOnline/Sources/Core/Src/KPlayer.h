...
public:
	...
	void 			XepHinhInvite(int nNpcIdx);
	#ifdef _SERVER
	void			c2sXepHinhInvite(BYTE* pProtocol);
	#endif
	void			s2cXepHinhInvite(BYTE* pProtocol);
	void			XepHinhReply(unsigned int uId, int nReply);
	#ifdef _SERVER
	void			c2sXepHinhReply(BYTE* pProtocol);
	#endif
