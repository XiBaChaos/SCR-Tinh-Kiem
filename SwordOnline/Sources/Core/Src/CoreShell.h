...
enum GAMEDATA_CHANGED_NOTIFY_INDEX
{
	...
	GDCNI_OPEN_EQUIPEX_BOX,		//打开储物箱
	
	GDCNI_SWITCHING_MAPMODE,	//地图切换
...
enum GAMEOPERATION_INDEX
{
	...
	GOI_TRADE_FOLKGAMEID,					//交易
	
	GOI_TRADE_CANCEL,			//交易取消

	GOI_SPAR_INVITE_RESPONSE,	//答应/拒绝交易请求
...
enum GAME_SCENE_MAP_OPERATION_INDEX
{
	...
	GSMOI_SCENE_TIME_INFO_OFTEN,			//当前主角所处的地域时间环境
...
enum GAME_TONG_OPERATION_INDEX
{
	...
	GTOI_TONG_FLAG,		//查询某人的招人开关
	//uParam = (KUiPlayerItme*) 要查谁
	//Return = (int)(bool)		是否开着的招人开关
	GTOI_TONG_FIGURE,		//查询某人的招人开关
...
enum GAME_PLAYERAI_OPERATION_INDEX
{
	...
	GPI_FIGHT_AUTO,
	GPI_RANGER_AUTO,
	GPI_DISTANCE_AUTO, //pius Distnace
	GPI_FIGHT_USE_SB,
	GPI_SUPPORT_SKILLS,
	GPI_FIGHT_SKILLS,
	GPI_FIGHTBACK,
	...
	GPI_OVER_TARGET,
	GPI_FOLLOW_TARGET,
	GPI_QUANH_DIEM_TARGET, //pius Quanh Diem
	GPI_SORT_EQUIPMENT,
...
struct _declspec (novtable) iCoreShell
{
	...
	//pius start 05/12/2023
	virtual void XepHinhInvite(void* pPlayer) = 0;
