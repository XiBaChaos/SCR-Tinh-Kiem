...
enum ITEM_POSITION
{
	...
	pos_give,
	pos_compound,
	pos_builditem, //pius Kham nam xanh
	pos_compoundroom,
	pos_num,
};
...
enum UIOBJECT_CONTAINER
{
	...
	UOC_SKILL_TREE,
	UOC_ITEM_GIVE,
	UOC_BUILD_ITEM, //pius kham nam xanh
	UOC_COMPOUND,
	UOC_COMPOUND_BOX,
	//左、右可用技能树
};
...
enum OPTIONS_LIST
{
	...
	OPTION_OTHER,			//pius Toi uu hinh anh
};
