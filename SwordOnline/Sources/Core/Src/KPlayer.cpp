...
//pius start 05/12/2023
//void KPlayer::XepHinhInvite(void* pPlayer)
//{
	//todo
//}
...
//pius start 05/12/2023
	void KPlayer::XepHinhInvite(int nNpcIdx)
	{

	}
	#ifdef _SERVER
	void KPlayer::c2sXepHinhInvite(BYTE* pProtocol)
	{
		
	}
	#endif
	void KPlayer::s2cXepHinhInvite(BYTE* pProtocol)
	{
		
	}
	void KPlayer::XepHinhReply(unsigned int uId, int nReply)
	{
		
	}
	#ifdef _SERVER
	void KPlayer::c2sXepHinhReply(BYTE* pProtocol)
	{
