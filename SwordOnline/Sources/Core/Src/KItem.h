...
public:
	...
	BYTE	GetKind() const { return m_CommonAttrib.nKind; }; // pius Kham nam xanh
	int		GetLine() const { return m_CommonAttrib.nLine; }; // pius Kham nam xanh
